...
test_zip_path = 'test_plateau.zip'
...
print("\nTest Metrics (plateau Data - Ensemble Fixed):")
...
results_df.to_csv('test_plateau_predictions_ensemble_fixed.csv', index=False)
print("\nPredictions saved to 'test_plateau_predictions_ensemble_fixed.csv'")
...
plt.title('Precision-Recall Curve for plateau Test (Ensemble Fixed)')
plt.legend()
plt.savefig('pr_curve_plateau_ensemble_fixed.png')
plt.show()